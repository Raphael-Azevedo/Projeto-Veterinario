...
namespace DogAPI.Migrations
{
    public partial class Populausuario : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("INSERT INTO `apidogdb`.`AspNetUserClaims` (`UserId`, `ClaimType`, `ClaimValue`) VALUES ('2fc41cdf-5852-4817-8968-89543e4fc23b', 'Acesso', 'Admin');");
            migrationBuilder.Sql("INSERT INTO `apidogdb`.`AspNetUserClaims` (`UserId`, `ClaimType`, `ClaimValue`) VALUES ('a1cf9047-8e65-4808-a651-d15c059019c6', 'Acesso', 'usuario');");

        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("drop table `apidogdb`.`AspNetUsers`");
            migrationBuilder.Sql("drop table `apidogdb`.`AspNetUserClaims`");
        }
    }
}
